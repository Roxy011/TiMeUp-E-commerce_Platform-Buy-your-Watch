...
import img1 from '../../assets/hero/women.webp';
...
const Hero = ({handleOrderPopup}) => {
  ...
  return (
    <div className='realative overflow-hidden min-h-[550px] sm:min-h-[580px] bg-gray-100 flex justify-center dark:bg-gray-950 dark:text-white duration-200'>
        {/* background pattern */}
      <div className='h-[700px] w-[700px] bg-primary/60 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-9'>
      </div>
        {/* hero section */}
                ...
                {ImgList.map((data) => (
                    ...
                    {/* text content section */}
                        <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                            ...
                            <p data-aos="zoom-out" data-aos-duration="500" data-aos-delay="100" data-aos-once="true" className='text-sm'>
                            {data.description}
                            </p>
                            <div
                            data-aos="zoom-out" data-aos-duration="500" data-aos-delay="300" data-aos-once="true">
